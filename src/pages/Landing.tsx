  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 pt-10 pb-20 lg:pt-16 lg:pb-32 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col items-center gap-1 text-muted-foreground mb-6 text-base">
              <span>{t("landing.noNoise")}</span>
              <span>{t("landing.noBlackHoles")}</span>
              <span>{t("landing.noForgottenIssues")}</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="text-lg px-8 py-6 text-white hover:opacity-90" style={{ backgroundColor: '#FF6B35' }}>
                <Link to="/auth">
                  {t("landing.startFreeTrial")} <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" asChild className="text-lg px-8 py-6">
                <Link to="/how-it-works">{t("landing.watchDemo")}</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-10">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">{t("landing.humanInterface")}</h3>
              <p className="text-muted-foreground text-sm">
                {t("landing.humanInterfaceDesc")}
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2">{t("landing.transparentAction")}</h3>
              <p className="text-muted-foreground text-sm">
                {t("landing.transparentActionDesc")}
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2">{t("landing.governanceTitle")}</h3>
              <p className="text-muted-foreground text-sm">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-bold mb-8">{t("landing.builtFor")}</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
              <div className="flex flex-col items-center gap-2 p-6 rounded-lg bg-card border transition-all duration-200 ease-out hover:scale-[1.02] hover:shadow-md">
                ...
                <span className="font-medium">{t("landing.officesTeams")}</span>
                <span className="text-sm text-muted-foreground">{t("landing.officesTeamsDesc")}</span>
              </div>
              <div className="flex flex-col items-center gap-2 p-6 rounded-lg bg-card border transition-all duration-200 ease-out hover:scale-[1.02] hover:shadow-md">
                <Home className="w-8 h-8 text-primary" />
                <span className="font-medium">{t("landing.residentialBuildings")}</span>
                <span className="text-sm text-muted-foreground">{t("landing.residentialBuildingsDesc")}</span>
              </div>
              <div className="flex flex-col items-center gap-2 p-6 rounded-lg bg-card border transition-all duration-200 ease-out hover:scale-[1.02] hover:shadow-md">
                <Users className="w-8 h-8 text-primary" />
                <span className="font-medium">{t("landing.communitiesAssociations")}</span>
                <span className="text-sm text-muted-foreground">{t("landing.communitiesAssociationsDesc")}</span>
              </div>
            </div>
            <p className="text-sm text-muted-foreground">{t("landing.oneEngine")}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-bold mb-6">{t("landing.ctaHeadline")}</h2>
